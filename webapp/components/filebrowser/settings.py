...
try:
    ...
    DEFAULT_URL_TINYMCE = settings.ADMIN_MEDIA_PREFIX + "js/tinymce/"
    DEFAULT_PATH_TINYMCE = os.path.join(settings.MEDIA_ROOT, 'js/tinymce/jscripts/tiny_mce/')
...
DIRECTORY = getattr(settings, "FILEBROWSER_DIRECTORY", 'upload/')
